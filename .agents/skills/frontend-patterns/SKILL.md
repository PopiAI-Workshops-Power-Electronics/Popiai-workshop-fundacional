...
Use this skill when working with this repository's Next.js 15 frontend code: pages, components, and routing.
...
- Components: `apps/frontend/components/` or colocated under `apps/frontend/app/`
- Hooks: `apps/frontend/hooks/` or colocated under `apps/frontend/app/`
