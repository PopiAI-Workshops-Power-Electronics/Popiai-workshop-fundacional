...
1. **FIRST** check if `.agents/skills/brand-design/SKILL.md` exists and read it
...
Codex can produce distinctive creative work when the direction is intentional. Commit fully to the chosen visual concept while respecting the project brand and technical constraints.
