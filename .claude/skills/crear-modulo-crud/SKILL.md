...
description: "Crea un modulo CRUD completo con backend NestJS (schema, DTOs, service, controller, tests) y frontend NextJS (pagina, componentes, hooks) siguiendo las convenciones del proyecto Workshop PopiAI. Usa esta skill cuando el usuario pida crear un modulo CRUD completo para una entidad."
license: MIT
---

# Crear Modulo CRUD Completo

Esta skill automatiza la creacion de un modulo CRUD completo en el proyecto Workshop.

## Instrucciones

Cuando el usuario pida crear un modulo CRUD completo, sigue estos pasos:
...
Genera los siguientes archivos en `apps/frontend/`:
...
```
Usuario: crea un modulo CRUD completo para benefit
Agente: ¿Que campos necesitas para el modelo Benefit?
Usuario: name: string, description: string, discount: number, category: string, isActive: boolean
Agente: [Genera todos los archivos...]
...
Archivos generados:
  ...
  - apps/frontend/app/benefits/page.tsx
  - apps/frontend/components/benefits/BenefitList.tsx
  - apps/frontend/hooks/useBenefits.ts
